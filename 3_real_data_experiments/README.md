...
The output of the below setup steps, `AGGREGATE_FASTAS` and `CUMULATIVE_VCFS`, are already included in the `input` folder.

To prepare them yourself, first, download metadata file that contains dates for each sample, sort the samples by date, and create VCFs and MSAs for each batch:
```
...
| Iteration | Total Sequences | Threads | Wall Clock Time | RAM (kB) | Parsimony | LogLk (under IQ-TREE model) | LogLk (under RAxML-NG model) |
|-----------|-----------------|---------|-----------------|----------|-----------|-------|-------|
| 1 | 4677 | 14 | 0h:0m:26s | 41552 | 3018 | -73797.147 | -73771.624 |
| 2 | 8903 | 14 | 0h:1m:34s | 68472 |5519 | -101394.773 | -- |
| 3 | 13242 | 14 |0h:3m:45s | 94600 | 8050| -128938.962 | -- |
